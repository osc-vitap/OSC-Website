...
import Event from "./../../../images/team/eb5.png";
import Tech from "./../../../images/team/ph.png";
import PR from "./../../../images/team/ph.png";
import Tech2 from "./../../../images/team/eb9.png";
...
function TeamWIOS() {
    return (
        <div>
            <Header {...headerObjEight} />
            <div className="board-category5">
                <div className="category-title">Diversity.</div>
            </div>
            ...
            <div className="mcard-container">
                    ...
                    <div className="mcard-name">Sukhmani Sandhu</div>
                ...
                <div className="mcard-container">
                    ...
                    <div className="mcard-name">TBA</div>
                ...
                <div className="mcard-container">
                    ...
                    <div className="mcard-name">Anshika Singh</div>
                    <div className="mcard-title">Chairperson</div>
                    <div className="mcard-flex">
                        <div className="b1"></div>
                        <div className="b2"></div>
                        <div className="b3"></div>
                ...
                <div className="mcard-container">
                    ...
                    <div className="mcard-name">TBA</div>
                    <div className="mcard-title">PR and Guest Care</div>
                    <div className="mcard-flex">
                        <div className="b1"></div>
                        <div className="b2"></div>
                        <div className="b3"></div>
                ...
                <div className="mcard-container">
                    ...
                    <div className="mcard-name">Srikurmum Harichandana</div>
                    <div className="mcard-title">Associate Tech Lead</div>
                    <div className="mcard-flex">
                        <div className="b1"></div>
                        <div className="b2"></div>
                        <div className="b3"></div>
